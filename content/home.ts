...
export const hero = {
  ...
  notes: ["Ages 16 to 22", "In person in Dallas", "Live online nationwide"],
};
...
export const programs = {
  ...
  items: [
    ...
    },
    {
      ...
      icon: "chats",
      body: "Our empowerment track for ages 16 to 22. Confidence, communication, and the skills that do not appear on a transcript but decide everything.",
    },
  ],
} as const;
